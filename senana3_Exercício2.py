...
class ContaCorrente:
    ...
    def sacar(self, valor: float):
        ...
        if self.__titulares[0].tem_cheque_especial() == False:
...
cliente_mulher = ClienteMulher("Sophia", "232323", 30000.0)
cliente_homem = ClienteHomem("Eduardo", "98769876", 1000.0)
